...
@endif
    ...
    <div class="text-center">
        <img src="/storage/avatars/{{ $user->avatar }}" class="avatar img-circle img-thumbnail" alt="avatar">
    	...
    	<div class="col-sm-9">
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                <hr>
                <form action="/tenant.profile" method="post" enctype="multipart/form-data">
                @csrf
