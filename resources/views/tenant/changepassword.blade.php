...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="text-center"class="card-header">Update Password </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('change.password') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"title="You need one uppercase and some number and need more than 8 characters">
                                @error('password')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
